	...
	<div class="container">
		<div id="quiz">
			...
			<div class="question">
				...
				<label><input type="radio" id="mc" name="question1" value="Siden vi er gode venner, ville jeg si ja.">Siden vi er
					gode venner, ville jeg si ja.</label>
				<Br>
				<input type="radio" id="mc" name="question1" value="Jeg ville sagt nei til den personen siden man kan ikke stole på alle på internett.">Jeg
				ville sagt nei til den personen siden man kan ikke stole på alle på internett.
				<BR>
				<input type="radio" id="mc" name="question1" value="Jeg ville sagt je, men tatt med meg en voksen.">Jeg ville sagt
				...
				<input type="radio" id="mc" name="question2" value="Nei, aldri!">Nei, aldri!
				<BR>
				<input type="radio" id="mc" name="question2" value="Ja, vi har kjent hverandre lenger så hvorfor ikke?">Ja, vi har
				kjent hverandre lenger så hvorfor ikke?
				<BR>
				<input type="radio" id="mc" name="question2" value="Jeg hadde sendt bilde av noen andre og latet som at det er meg.">Jeg
				...
				<input type="radio" id="mc" name="question3" value="Ja, i det minste så er gratis og uansett så burde barn lære seg å kontrollere ønskene sine">Ja,
				i det minste så er gratis og uansett så burde barn lære seg å kontrollere ønskene sine
				<BR>
				<input type="radio" id="mc" name="question3" value="Nei, barn burde ikke bli fristet av dyrt elektronisk innhold, som ikke har noen virkelig verdi.">Nei,
