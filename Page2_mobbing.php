...
<header>
	<div class="container">
		...
		<form action="Page3_privacy.php" method="post" id="quiz">
			...
			<h1>Cybermobbing</h1>
			<div class="question">
				<h3>5. Forestill deg at en som blir mobbet på skolen kommer til deg og spør om de kan være sammen med deg. Hvis du blir venn med denne personen kan alle komme til å le av deg og begynne å mobbe deg også. Hva ville du gjort? </h3>
				...
				<h3>6. Hva hadde du gjort når du ser at noen er slemme mot deg eller andre på nettet?</h3>
				<br>
				...
				<h3>7. Noen du kjenner har delt dette bildet av seg selv på facebook:</h3>
					<br>
			...
			<footer>
				<br>
				<p id="progress">Spørsmål 7 av 10</p>
			</footer>
		</div>	 
	</div>
</header>
